...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/or-a/bj1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/or-a/bj2\ \(2\).jpg");
        }
        75% {
          background-image: url("../images/or-a/bj3.jpg");
        }
      }
    </style>
  </head>
  <body>
              ...
              <div class="contant">
                <div class="row">
                  ...
                  <ul class="activities">
                    ...
                    <li><a href="../adventures/campingphpl">camping</a></li>
                    <li>
    ...
    <div class="slide-div"><h3>bungee jumping</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for bungee jumping</h1>
    </div>
