...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/or-a/cf1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/or-a/cf2.jpg");
        }
        75% {
          background-image: url("../images/or-a/cf3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    <div class="slide-div"><h3>camel safari</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for camel safari</h1>
    </div>
      ...
      <section class="all-cards1">
        <a href="../destination_city/rajasthan.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/rajasthan/r4.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">
                camel safari camp in bikanen(rajasthan)
              </div>
        ...
        <a href="../destination_city/ladakh.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/ladakh/l10.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">camel safari in ladakh</div>
              <div class="card-content">
                Duration : 2D/1N <br />₹7,100(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/rajasthan.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/rajasthan/r10.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">camping in jodhpur with camel safari</div>
              <div class="card-content">
                Duration : 2D/1N <br />₹2,850(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
