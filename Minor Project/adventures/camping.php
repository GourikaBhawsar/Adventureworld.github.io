...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/land-a/c1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/land-a/c2.jpg");
        }
        75% {
          background-image: url("../images/land-a/c3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    <div class="slide-div"><h3>camping</h3></div>
    <div class="adventure-about">
      <div class="adventure-about1">
        <p>
          Camping is a recreational (and oftentimes laid-back) activity pursued
          outdoors, away from cities and towns and in the lap of nature, with
          fresh air and (occasionally) wildlife for company. One can set up a
          tent, or live in a caravan, camper-van or motor-home when camping. But
          the classic camping trip involves toughing it out in tents – and at
          the mercy of Mother Nature. Camping can be – and usually is – combined
          with other adventure activities, such as hiking/trekking, fishing,
          whitewater rafting and kayaking, giving one the ultimate outdoors
          experience. It can be an individual pursuit, but is often done in the
          company of friends and family. It’s a pastime that can be enjoyed by
    ...
    <div class="alag-card">
      <h1>best destination for camping</h1>
    </div>
      ...
      <section class="all-cards1">
        <a href="../destination_city/ladakh.php">
          <div class="card +7Days all">
            <div class="card-img">
              <img src="../images/ladakh/l6.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">magical ladakh camping</div>
              <div class="card-content">
                Duration : 6D/5N <br />₹20,100(per person)
              </div>
        ...
        <a href="../destination_city/rajasthan.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/rajasthan/r1.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">Camping at mount abu (rajasthan)</div>
              <div class="card-content">
                Duration :2D/1N <br />₹1,950(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/rajasthan.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/rajasthan/r2.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">
                camping&camel safari in bikaner(rajasthan)
              </div>
              <div class="card-content">
                Duration : 2D/1N <br />₹3,100(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/near-mumbai.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/near-mumbai/nm2.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">pawna lake camping(near-mumbai)</div>
              <div class="card-content">
                Duration :2D/1N <br />₹749(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/near-mumbai.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/near-mumbai/nm8.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">
                ratangad&sandhan valley camping&trekking
              </div>
              <div class="card-content">
                Duration : 2D/1N
                <br />₹2,390(per person)
