...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/land-a/cl1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/land-a/cl2.jpg");
        }
        75% {
          background-image: url("../images/land-a/cl3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    ../destination_city/
    <div class="slide-div"><h3>cycling</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for cycling</h1>
    </div>
      ...
      <section class="all-cards1">
        <a href="../destination_city/goa.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/goa/g8.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">Cycling tour of old goa</div>
        ...
        <a href="../destination_city/rajasthan.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/rajasthan/r8.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">
                udaipur old city cycling tour (rajasthan)
              </div>
              <div class="card-content">
                Duration : 2H
                <br />₹590(per person)
        ...
        <a href="../destination_city/ladakh.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/ladakh/l12.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">mountain cycling ladakh</div>
              <div class="card-content">
                Duration : 7H
                <br />₹3,100(per person)
              </div>
        ...
        <a href="../destination_city/rajesthan.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/rajasthan/r11.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">jodhpur cycling tour (rajasthan)</div>
              <div class="card-content">
                Duration : 3H <br />₹700(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
