...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/air-a/b1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/air-a/b2.jpg");
        }
        75% {
          background-image: url("../images/air-a/b3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    ../destination_city/
    <div class="slide-div"><h3>hot air Balloon</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for hot air Balloon</h1>
    </div>
      ...
      <section class="all-cards1">
        <a href="../destination_city/rajasthan.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/rajasthan/r3.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">
                hot air ballooning safari in Jaipur(rajasthan)
              </div>
              <div class="card-content">
                Duration : 1H <br />₹12,000(per person)
              </div>
        ...
        <a href="../destination_city/goa.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/goa/g3.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">hot air Ballooning in goa</div>
              <div class="card-content">
                Duration : 3H <br />₹11,000(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/rajasthan.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/rajasthan/r6.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">
                hot air balloon safari in pushkar(rajasthan)
              </div>
              <div class="card-content">
                Duration : 1H <br />₹15,000(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/near-mumbai.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/near-mumbai/nm5.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">
                hot air balloon safari lonavla (near mumbai)
              </div>
              <div class="card-content">
                Duration : 1H<br />₹6,200(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
