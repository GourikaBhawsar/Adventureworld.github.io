...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/water-a/kk1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/water-a/kk2.jpg");
        }
        75% {
          background-image: url("../images/water-a/kk3\ \(2\).jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    <div class="slide-div"><h3>Kayaking</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for Kayaking</h1>
    </div>
    <section class="all-cards">
      <section class="all-cards1">
        ...
        <a href="../destination_city/goa.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/goa/g5.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">Kayaking in goa</div>
              <div class="card-content">
                Duration : 2H <br />₹500(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/goa.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/goa/g9.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">group Kayaking in goa</div>
              <div class="card-content">
                Duration : 4H <br />₹6,025(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
