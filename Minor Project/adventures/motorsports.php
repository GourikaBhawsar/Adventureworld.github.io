...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/land-a/ms1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/land-a/ms2.jpg");
        }
        75% {
          background-image: url("../images/land-a/ms3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    <div class="slide-div"><h3>motorsports</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for motorsports</h1>
    </div>
      ...
      <section class="all-cards1">
        ...
        <a href="../destination_city/kerala.php">
          <div class="card +7Days all">
            ...
            <div class="gouri">
              <div class="card-titel">the west coast bike tour (kerala)</div>
              <div class="card-content">
        ...
        <a href="../destination_city/ladakh.php">
          <div class="card +7Days all">
            <div class="card-img">
              <img src="../images/ladakh/l1.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">motorbike adventure in ladakh</div>
              <div class="card-content">
                Duration :6D/5N <br />₹11,500(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/ladakh.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/ladakh/l8.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">journey to ladakh</div>
              <div class="card-content">
                Duration : 5D/4N <br />₹8,100(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        </a>
        <a href="../destination_city/rajesthan.php">
          <div class="card +7Days all">
            <div class="card-img">
              <img src="../images/rajasthan/r9.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">rajasthan motorbike tour</div>
              <div class="card-content">
                Duration : 8D/7N <br />₹32,160(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/ladakh.php">
          <div class="card +7Days all">
            <div class="card-img">
              <img src="../images/ladakh/l4.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">leh to leh road trip ladakh</div>
              <div class="card-content">
                Duration : 6D/5N <br />₹8,100(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
