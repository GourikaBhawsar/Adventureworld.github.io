...
<html lang="en">
  <head>
    ...
    />
    <title>parasaling</title>
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/air-a/pr1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/air-a/pr2.jpg");
        }
        75% {
          background-image: url("../images/air-a/pr3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    <div class="slide-div"><h3>parasaling</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for parasaling</h1>
    </div>
      ...
      <section class="all-cards1">
        <a href="../destination_city/goa.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/goa/g2.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">parasailing in baga beach goa</div>
              <div class="card-content">
                Duration : 1H <br />₹650(per person)
              </div>
        ...
        <a href="../destination_city/rajasthan.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/rajasthan/r7.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">parasailing in alwar(rajasthan)</div>
              <div class="card-content"><br />₹563(per person)</div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        </a>
