...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/water-a/rr-1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/water-a/rr-2.jpg");
        }
        75% {
          background-image: url("../images/water-a/rr-3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    ../destination_city/
    <div class="slide-div"><h3>water rafting</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for water rafting</h1>
    </div>
      ...
      <section class="all-cards1">
        <a href="../destination_city/rishikesh.php">
          <div class="card 1Day all">
            ...
            <div class="gouri">
              <div class="card-titel">Water Rafting Tour in Rishikesh</div>
              <div class="card-content">
                Duration : 2H <br />₹600(per person)
              </div>
        ...
        <a href="../destination_city/goa.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/goa/g10.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">river rafting in goa</div>
              <div class="card-content">
                Duration : 1D <br />₹1500(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/ladakh.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/ladakh/l11.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">rafting in zanskar ladakh</div>
              <div class="card-content"><br />₹3,100(per person)</div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        </a>
        <a href="../destination_city/near-mumbai.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/near-mumbai/nm3.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">Kundalika rafting camp (near-mumbai)</div>
              <div class="card-content">
                Duration :2D/1N<br />₹2,100(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/near-mumbai.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/near-mumbai/nm4.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">kolad river rafting mumbai</div>
              <div class="card-content">
                Duration : 1D <br />₹2500(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
