...
<html lang="en">
  <head>
    ...
    />
    <title>rock climbing,reppling</title>
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/or-a/rc1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/or-a/rc2.jpg");
        }
        75% {
          background-image: url("../images/or-a/rc3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    ../destination_city/
    <div class="slide-div"><h3>rock climbing,reppling</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for rock climbing,reppling</h1>
    </div>
      ...
      <section class="all-cards1">
        ...
        <a href="../destination_city/ladakh.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/ladakh/l13.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">rock climbing in ladakh</div>
              <div class="card-content">
                Duration : 4D/3N
                <br />₹15,100(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
