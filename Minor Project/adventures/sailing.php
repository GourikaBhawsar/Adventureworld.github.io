...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/water-a/sl1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/water-a/sl2.jpg");
        }
        75% {
          background-image: url("../images/water-a/s;3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    ../destination_city/
    <div class="slide-div"><h3>sailing</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for sailing</h1>
    </div>
      ...
      <section class="all-cards1">
        <a href="../destination_city/goa.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/goa/g4.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">discover sailing in goa</div>
              <div class="card-content">
                Duration : 1.5H <br />₹5,000(per person)
              </div>
        ...
        <a href="../destination_city/near-mumbai.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/near-mumbai/nm10.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">sailing in mumbai</div>
              <div class="card-content">
                Duration : 2H<br />₹3,465(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/goa.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/goa/g11.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">group sailing in goa</div>
              <div class="card-content">
                Duration : 1D <br />₹5,090(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
