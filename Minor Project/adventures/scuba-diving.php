...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/water-a/sd1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/water-a/sd2.jpg");
        }
        75% {
          background-image: url("../images/water-a/sd3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    ../destination_city/
    <div class="slide-div"><h3>scuba diving</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for scuba diving</h1>
    </div>
      ...
      <section class="all-cards1">
        <a href="../destination_city/goa.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/goa/g1.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">grand island scuba diving in goa</div>
              <div class="card-content">
                Duration :10H<br />₹1,380(per person)
              </div>
        ...
        <a href="../destination_city/near-mumbai.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/near-mumbai/nm7.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">tarkari scuba diving (near mumbai)</div>
              <div class="card-content">
                Duration : 3H <br />₹8,17(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
