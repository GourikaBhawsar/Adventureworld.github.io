...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/or-a/sk1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/or-a/sk2.jpg");
        }
        75% {
          background-image: url("../images/or-a/sk3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    ../destination_city/
    <div class="slide-div"><h3>skiing</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for skiing</h1>
    </div>
