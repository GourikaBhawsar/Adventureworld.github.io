...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/or-a/tr1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/or-a/tr2.jpg");
        }
        75% {
          background-image: url("../images/or-a/tr3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    <div class="slide-div"><h3>tree house</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for tree house</h1>
    </div>
