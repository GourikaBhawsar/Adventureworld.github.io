...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/land-a/tr1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/land-a/tr2.jpg");
        }
        75% {
          background-image: url("../images/land-a/tr3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    ../destination_city/
    <div class="slide-div" ><h3>trekking</h3></div>
    <div class="adventure-about">
      <div class="adventure-about1">
        <p>
          Trekking is recreational activity that involves covering any specified
          journey on foot. This is mostly done in rural areas and rugged
          regions. Trekking is often done in combination with backpacking and
          rock climbing. <br />
          <br />Trekking is mainly done to have an interaction with nature.
          Trekkers cross forest areas, mountains, deserts and face different
          weather conditions and topographies. The activity does not require
          much of planning and is usually done in groups. The travelling through
          isolated areas by being close to nature and surroundings; makes this
          activity enjoyable and worth an experience. <br />
          <br />
        </p>
      </div>
    </div>
    <div class="alag-card">
      <h1>best destination for trekking</h1>
    </div>
      ...
      <section class="all-cards1">
        <a href="../destination_city/ladakh.php">
          <div class="card +7Days all">
            <div class="card-img">
              <img src="../images/ladakh/l3.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">markha valley trek ladakh</div>
              <div class="card-content">
                Duration : 9D/8N <br />₹9,300(per person)
              </div>
        ...
        <a href="../destination_city/ladakh.php">
          <div class="card +7Days all">
            <div class="card-img">
              <img src="../images/ladakh/l9.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">snow leopard trekking ladakh</div>
              <div class="card-content">
                Duration : 8D/7N <br />₹38,100(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/ladakh.php">
          <div class="card +7Days all">
            <div class="card-img">
              <img src="../images/ladakh/l2.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">chadar forzer river trek ladakh</div>
              <div class="card-content">
                Duration : 9D/8N <br />₹6,100(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/ladakh.php">
          <div class="card +7Days all">
            <div class="card-img">
              <img src="../images/ladakh/l7.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">
                chadar and lingshed village trek ladakh
              </div>
              <div class="card-content">
                Duration : 12D/11N <br />₹22,100(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/goa.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/goa/g12.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">keri to arambol trek in goa</div>
              <div class="card-content">
                Duration : 1D <br />₹1165(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        ...
        <a href="../destination_city/near-mumbai.php">
          <div class="card 2-5Days all">
            <div class="card-img">
              <img src="../images/near-mumbai/nm1.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">
                Sandhan Valley trek with rappelling , lgatputi(near-mumbai)
              </div>
              <div class="card-content">
                Duration :2D/1N <br />₹1,100(per person)
              </div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
