...
<html lang="en">
  <head>
    ...
    <style>
      .slide-div {
        width: 100%;
        height: 600px;
        background-image: url("../images/air-a/z1.jpg");
      ...
      @keyframes slider {
        ...
        35% {
          background-image: url("../images/air-a/z2.jpg");
        }
        75% {
          background-image: url("../images/air-a/z3.jpg");
        }
      }
    </style>
  </head>
  <body>
    ...
    ../destination_city/
    <div class="slide-div"><h3>zip line</h3></div>
    ...
    <div class="alag-card">
      <h1>best destination for zip line</h1>
    </div>
    <section class="all-cards">
      <section class="all-cards1">
        ...
        <a href="../destination_city/near-mumbai.php">
          <div class="card 1Day all">
            <div class="card-img">
              <img src="../images/near-mumbai/nm9.jpg" alt="" />
            </div>
            <div class="gouri">
              <div class="card-titel">zip line in kolad(near-mumbai)</div>
              <div class="card-content"><br />₹430(per person)</div>
              <button class="book-now-btn">Book Now</button>
            </div>
          </div>
        </a>
