    ...
    <div class="main-team">
      <div class="card-team">
        <div class="card-team-img">
          <img src="../images/team/satyam3.jpg" />
        </div>
        <div class="card-team-contant">
          <h1>satyam joshi</h1>
          <h2 style="padding-left: 20px">CEO,Adventure World</h2>
        </div>
      </div>
      <div class="card-team">
        <div class="card-team-img">
          <img src="../images/team/pathak1.jpg" alt="" />
        </div>
        <div class="card-team-contant">
          <h1>Aaditya pathak</h1>
          <h2>CO-Founder,Adventure World</h2>
        </div>
      </div>
      <div class="card-team">
        <div class="card-team-img">
          <img src="../images/team/kanu.jpg" alt="" />
        </div>
        <div class="card-team-contant">
          <h1>Parth Bhawsar</h1>
          <h2>Director,Adventure World</h2>
        </div>
      </div>
    </div>
    <!--footer start-->
